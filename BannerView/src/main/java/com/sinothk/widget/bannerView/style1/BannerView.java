...
import com.sinothk.widget.bannerView.style1.listener.OnBannerClickListener;
import com.sinothk.widget.bannerView.style1.listener.OnBannerListener;
import com.sinothk.widget.bannerView.style1.loader.ImageLoaderInterface;
import com.sinothk.widget.bannerView.style1.view.BannerViewPager;
...
public class BannerView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.banner_white_radius);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.banner_gray_radius);
    ...
    private void setTitleStyleUI() {
        if (titles.size() != imageUrls.size()) {
            throw new RuntimeException("[BannerView] --> The number of titles and images is different");
        }
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void onPageSelected(int position) {
        ...
        if (bannerStyle == BannerConfig.NUM_INDICATOR) {
            numIndicator.setText(position + "/" + count);
        }else if(BannerConfig.NUM_INDICATOR_TITLE == bannerStyle){
            numIndicatorInside.setText(position + "/" + count);
            bannerTitle.setText(titles.get(position - 1));
        }else if(BannerConfig.CIRCLE_INDICATOR_TITLE == bannerStyle){
            bannerTitle.setText(titles.get(position - 1));

        }else if(BannerConfig.CIRCLE_INDICATOR_TITLE_INSIDE == bannerStyle){
            bannerTitle.setText(titles.get(position - 1));
        }
